...
// Call it once after deployment: POST /api/seed
export async function POST(request: NextRequest) {
  try {
    // Optional: Add a secret key for security
    const authHeader = request.headers.get('authorization');
    const expectedSecret = process.env.SEED_SECRET || 'tron-solar-seed-2025';
    ...
    console.log(`Created/updated ${vehicleCount} vehicle inventory items`);
